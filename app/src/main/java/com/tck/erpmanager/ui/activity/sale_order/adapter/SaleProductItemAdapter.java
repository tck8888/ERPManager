...
public class SaleProductItemAdapter extends BasicAdapter<ProductListBean.DataBean> {


    public SaleProductItemAdapter(Context context, List<ProductListBean.DataBean> dataList) {
